...
class S3Spec extends FlatSpec with Matchers {
  ...
  it should "handle buckets with > 1000 objects in them " in {
    ...
    val file = new java.io.File("aws/s3/src/main/scala/S3.scala")
    for (i <- 1 to 1002) {
  ...
  it should "provide cool APIs" in {
    ...
    // create/update objects
    bucket.put("S3.scala", new java.io.File("aws/s3/src/main/scala/S3.scala"))
    bucket.putAsPublicRead("S3.scala", new java.io.File("aws/s3/src/main/scala/S3.scala"))
    bucket.put("S3Spec.scala", new java.io.File("aws/s3/src/test/scala/S3Spec.scala"))
